...
//        echo "<script type='text/javascript'>window.top.location='http://www.carpinteriamasmadera.com/prueba/backend/login.php';</script>"; exit;
    }
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          ...
          <a id="cargar" class="nav-link" href="categoriaform.php">
            <i class="fa fa-fw fa-area-chart"></i>
            <span class="nav-link-text">Categorias</span>
          </a>
        </li> 
           <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Categorias-Subir imagen">
          <a id="cargar" class="nav-link" href="subirimagen.php">
            <i class="fa fa-fw fa-area-chart"></i>
            <span class="nav-link-text">Categorias-Subir imagen</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Categorias-Subir imagen">
          <a id="cargar" class="nav-link" href="changepass.php">
            <i class="fa fa-fw fa-area-chart"></i>
